...
TESTNAME = "cl::linalg::vec_innerprod_f"
...
def gen_stimuli(N):
    ...
    """
    a = (np.random.randn(1, N) * 100).astype(np.float32)
...
def test():
    ...
    for N in [12, 13, 21, 22]:
        ...
        header.add(HeaderArray("y_exp", "uint32_t", [y], formatter=float_formatter))
